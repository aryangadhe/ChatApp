...
import { chatContext } from '../../constest/ChatContext'
...
const Sidebar = () => {
  ...
  return (
    <div className={`bg-[#7b81c1]/10 h-full p-5 rounded-r-xl overflow-y-scroll
      ...
      <div className='pb-5'>
        <div className='flex justify-between items-center '>
            ...
            <div className='relative py-2 group'>
                ...
                bg-[#5f4da3] border border-gray-600 text-gray-100 hidden
                group-hover:block' >
